...
import { FileTooLargeError, InvalidFileTypeError } from '../../domain/errors/tournament-sponsor.errors.js';
...
export function uploadTournamentSponsorFiles(req: Request, res: Response, next: NextFunction): void {
