...
export class TournamentSponsorNotFoundError extends AppError {
    constructor() {
        super(404, 'TOURNAMENT_SPONSOR_NOT_FOUND', 'Tournament sponsor not found.');
    }
}
...
export class SponsorLimitReachedError extends AppError {
